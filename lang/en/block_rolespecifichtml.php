...
// Privacy.
$string['privacy:metadata'] = 'The Role Specific HTML Block does not directly store any personal data about any user.';
...
$string['configinherit'] = 'Inherit roles from higher contexts';
$string['configdisplay'] = 'Display';
$string['showallmatches'] = 'All matching roles';
$string['showhighest'] = 'Highest role message only';
$string['page'] = 'Context block is viewed in';
$string['parent'] = 'Context block was created in';
